...
<html lang=en>
	...
	<div class="float-sm-left"><a href="adminwork.php" class="btn btn-danger" role="button">BACK</a></div><br>
	<br><br>
  <h2>ADD QUESTION!!</h2>
  <form action="addque.php" method="post">
    ...
    <button type="submit" class="btn btn-primary" name="click">Submit</button><hr>
	  ...
	  if(isset($_POST['click'])){
		...
		$ins = "insert into quizz(id, ques, ans1 , ans2 , ans3 , ans4, corr_ans) VALUES ('$id','$question','$opt1','$opt2','$opt3','$opt4','$opt_corr')";
