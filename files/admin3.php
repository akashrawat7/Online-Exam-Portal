...
<html lang=en>
  ...
  <h2>Enter Starting Letters Related To the Question Which You Want TO Delete!!</h2><hr>
<form action="admin3.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="word"  name="word"  autocomplete="off" placeholder="Enter Starting Letters Related To the Question Which You Want TO Delete"  required>
  </div>
